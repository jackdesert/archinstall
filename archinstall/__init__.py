...
def define_arguments() -> None:
	...
	parser.add_argument("--teach", action="store_true", default=False, help="Teaching mode. Echoes all subprocess commands to the screen with a pause after each. Useful for understanding what is going on under the hood.")
